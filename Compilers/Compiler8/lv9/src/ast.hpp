...
class ConstInitValAST : public BaseAST {
 public:
  ...
  std::vector<int> CalculateArrayInitialization(std::vector<int>::iterator len_begin,
...
class VarDefAST : public BaseAST {
 private:
    void generate_global_var() const;
    void generate_local_var() const;
    void generate_array_allocation() const;
    void calculate_array_dimensions(std::vector<int>* len, std::vector<int>* mul_len) const;
    void initialize_array(std::vector<int>* len, std::vector<int>* mul_len) const;   
 public:
  int type;
  std::string ident;
  std::unique_ptr<std::vector<std::unique_ptr<BaseAST> > > const_index_list;
